...
class _BotMatchScreenState extends State<BotMatchScreen> {
  ...
  BoardState get _board => _controller.board;
  ...
  String get _currentPlayerName {
    return _board.currentPlayer == 1 ? widget.playerName : widget.botName;
  }

  Color _playerColor(int playerId) {
    return playerId == 1
        ? const Color(0xFF8FA9C4)
        : const Color(0xFFD39274);
  }
  ...
  void _showWinnerDialog(int winner) {
    final winnerName = winner == 1 ? widget.playerName : widget.botName;
        ...
        return Dialog(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Icon(
                  winner == 1 ? Icons.emoji_events : Icons.smart_toy,
          ...
          children: [
            Expanded(
              child: _PlayerProfileCard(
                ...
                isTurn: _board.currentPlayer == 1 && !_botThinking,
                alignLeft: true,
                icon: Icons.person,
              ),
            ),
            ...
            _CenterVsSection(
              ...
              levelText: widget.difficultyLabel,
            ),
            const SizedBox(width: 10),
            Expanded(
              child: _PlayerProfileCard(
                ...
                isTurn: _board.currentPlayer == 2 || _botThinking,
                alignLeft: false,
...
class _BoardNode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isEmpty && isValidDestination) {
      fillColor = const Color(0xFFFFD15C).withOpacity(0.55);
    } else if (isEmpty) {
